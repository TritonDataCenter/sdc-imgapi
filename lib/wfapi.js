 ...
 */
Wfapi.prototype.createImageFromVmJob =
function (vmUuid, manifest, cb) {
    var self = this;
    ...
    self.client.createJob(params.task, params, function (err, job) {
        if (err) {
            return cb(err);
        }
...
function (uuid, source, manifest, skipOwnerCheck, cb) {
    var self = this;
    var params = {
        image_uuid: uuid,
        source: source,

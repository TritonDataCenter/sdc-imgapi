...
function NoPrivateImagesError(cause) {
    assert.optionalObject(cause);
    RestError.call(this, {
        restCode: this.constructor.restCode,
        statusCode: this.constructor.statusCode,
        message: 'private images are not allowed',
        cause: cause
    });
}
util.inherits(NoPrivateImagesError, RestError);
NoPrivateImagesError.prototype.name = 'NoPrivateImagesError';
NoPrivateImagesError.restCode = 'NoPrivateImages';
NoPrivateImagesError.statusCode = 409;
NoPrivateImagesError.description = 'No private images are allowed on a public Images API.';
...
module.exports = {
    ...
    NoPrivateImagesError: NoPrivateImagesError,

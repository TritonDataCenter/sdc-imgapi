...
function StorageIsDownError(cause) {
    var message = 'manta storage is down at the moment';
    RestError.call(this, {
        restCode: this.constructor.restCode,
        statusCode: this.constructor.statusCode,
        message: message,
...
StorageIsDownError.description = 'Manta storage is down at the moment.';
...
function WfapiIsDownError(cause) {
    var message = 'workflow api is down at the moment';
    RestError.call(this, {
        restCode: this.constructor.restCode,
        statusCode: this.constructor.statusCode,
        message: message,
...
util.inherits(WfapiIsDownError, restify.ServiceUnavailableError);
WfapiIsDownError.prototype.name = 'WfapiIsDownError';
WfapiIsDownError.restCode = 'WfapiIsDown';
WfapiIsDownError.statusCode = 503;
WfapiIsDownError.description = 'Workflow API is down at the moment.';
samples.WfapiIsDownError = new WfapiIsDownError();
...
module.exports = {
    ...
    WfapiIsDownError: WfapiIsDownError,
...
if (require.main === module) {
    ...
    Object.keys(module.exports).forEach(function (e) {
        if (/Error$/.test(e)) {
            errors[e] = module.exports[e];
        }
    });
    var table = generateRestdownTable(errors);
    p(table);
}

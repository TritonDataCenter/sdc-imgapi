...
function NotImplementedError(cause, message) {
    if (message === undefined) {
        message = cause;
        cause = undefined;
    }
...
NotImplementedError.description = 'Not implemented by the HTTP server';


function RangeNotSatisfiableError(cause, message) {
    if (message === undefined) {
        message = cause;
        cause = undefined;
    }
...
util.inherits(RangeNotSatisfiableError, RestError);
RangeNotSatisfiableError.prototype.name = 'RangeNotSatisfiableError';
RangeNotSatisfiableError.restCode = 'RangeNotSatisfiable';
RangeNotSatisfiableError.statusCode = 416;
RangeNotSatisfiableError.description = 'Requested range is not satisfiable';

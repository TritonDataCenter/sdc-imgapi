...
function NotActivatedNoDisableError(cause, imageUuid) {
    if (imageUuid === undefined) {
        imageUuid = cause;
        cause = undefined;
    }
    var message = format("cannot enable/disable image '%s' if it has not "+
        "been activated yet", imageUuid);
    RestError.call(this, {
        restCode: this.constructor.restCode,
        statusCode: this.constructor.statusCode,
        message: message,
...
util.inherits(NotActivatedNoDisableError, RestError);
NotActivatedNoDisableError.prototype.name = 'NotActivatedNoDisableError';
NotActivatedNoDisableError.restCode = 'NotActivatedNoDisable';
NotActivatedNoDisableError.statusCode = 422;
NotActivatedNoDisableError.description =
'Cannot enable/disable non-activated images.';
samples.NotActivatedNoDisableError = new NotActivatedNoDisableError(
    'ed8cd007-2065-0140-8d41-e32247b71748');
...
module.exports = {
    ...
    NotActivatedNoDisableError: NotActivatedNoDisableError,

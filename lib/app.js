...
function getReqAuth(app, config) {
    if (config.mode === 'dc') {
    ...
    if (config.auth.type === 'basic') {
        ...
        return function reqBasicAuth(req, res, next) {
            ...
            req.log.trace({authorization: authorization}, 'basicVerify');
        ...
        return function reqSignatureAuth(req, res, next) {
            next();
            //function signatureVerify(req, cb) {
            ...
            //    }
            //    console.log("XXX sigInfo", sigInfo);
            //    //XXX
            //    var pubkey = fs.readFileSync('/Users/trentm/joy/imgapi/tmp/id_rsa.joyent2.pub.pem');
            //    //var pubkey = fs.readFileSync('/Users/trentm/joy/imgapi/node_modules/http-signature/tst/rsa_public.pem');
            //    cb(!httpSig.verifySignature(sigInfo, pubkey));
            //}
        };
    }
}
...
function App(config, log) {
    ...
    var reqAuth = getReqAuth(this, config);
